...
- Test plans, test sets, preconditions, custom fields and users are not
  migrated. See the README coverage table.
- Historical result timestamps are not preserved; duration and status are.
